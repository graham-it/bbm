...
;Display disk header
	...
	ldy #3			;pairs to read (skip load address)
	jsr GetPair		;get and display drive number
	bne DirExit

	jsr GetEntry		;get and display disk header
	bne DirExit
...
EntryLoop
	...
	ldy #2			;pairs to read
	jsr GetPair		;get and display size
	bne DirExit

	jsr GetEntry		;get and display entry
	bne DirExit

	jsr GetName		;extract file name
	lda data_len
	beq EntryLoop		;not found (empty string or "blocks free")
